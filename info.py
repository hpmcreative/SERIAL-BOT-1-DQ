...
PICS = (environ.get('PICS', 'http://graph.org/file/8138b4e7e70fab25d5e49.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002232982072 -1002242676006').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://lolan:lolan@cluster0.vkbdsfx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/asianet_surya_zee')
