    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                text=f"<b>Hᴇʏ {message.from_user.mention}, {str(total_results)} ʀᴇsᴜʟᴛs ᴀʀᴇ ғᴏᴜɴᴅ ɪɴ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ ғᴏʀ ʏᴏᴜʀ ᴏ̨ᴜᴇʀʏ {search}. നിങ്ങൾക്ക് ഇവിടെ സീരിയൽ ലഭിക്കില്ല.  സീരിയൽ ലഭിക്കാൻ സീരിയൽ ഗ്രൂപ്പിൽ ജോയിൻ ചെയുക.<a href=https://t.me/+3qzr2bXgjk42YmJl>‼️ സീരിയൽ ഗ്രൂപ്പ്‌  ‼️</a> താഴെ കാണുന്ന JOIN HERE എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്ത് ഗ്രൂപ്പിൽ ജോയിൻ ചെയുക 👇.\n\n https://t.me/+pv6pyymMy1tmZGY1</b>",
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Mallu_adminbot")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Mallu_adminbot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
