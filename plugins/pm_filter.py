    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                text=f"<b>Hᴇʏ {message.from_user.mention}, {str(total_results)} ‼️നിങ്ങൾക്ക് ഇവിടെ സീരിയൽ ലഭിക്കില്ല.  സീരിയൽ ലഭിക്കാൻ സീരിയൽ ഗ്രൂപ്പിൽ ജോയിൻ ചെയുക.‼️ സീരിയൽ ഗ്രൂപ്പ്‌  ‼️ താഴെ കാണുന്ന JOIN HERE എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്ത് ഗ്രൂപ്പിൽ ജോയിൻ ചെയുക 👍 👇.\n\n https://t.me/+3qzr2bXgjk42YmJl</b>",
